...
import com.inventrax_pepsi.common.collections.Lists;
...
public class AndroidUtils {
    ...
    public static String getIMEINumber(){
        ...
        TelephonyManager telephonyManager = (TelephonyManager) AbstractApplication.get().getSystemService(Context.TELEPHONY_SERVICE);
