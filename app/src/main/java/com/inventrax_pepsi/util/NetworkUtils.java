    ...
    static class InternetAvailabilityCheckTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            try {
                ...
                SoapObject request = new SoapObject(ServiceURLConstants.WSDL_TARGET_NAMESPACE,params[0]);

                for (PropertyInfo pIf : PropList) {
                ...
                HttpTransportSE httpTransport = new HttpTransportSE(ServiceURLConstants.SOAP_ADDRESS_ASMX);

                try {

                    httpTransport.call(ServiceURLConstants.SOAP_ACTION_URL + params[0],
                            envelope);
