...
public class Order {
    ...
    private int autoIncId,customerId,routeId,orderType,paymentStatus,orderStatus,jsonMessageAutoIncId,paymentMode,orderId;
    private String orderCode,customerCode,routeCode,createdOn,orderJSON;
    private double orderQuantity,orderPrice,derivedPrice;
